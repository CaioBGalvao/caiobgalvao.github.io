...
const techs = [
  ...
  },
  {
    ...
    "text": 'React Router enables "client side routing".',
  ...
  },
  {
    "src": Helmet,
    "title": "React Helmet",
    "text": "This reusable React component will manage all of your changes to the document head.",
  ...
  },
  {
    "src": EmailJs,
    "title": "EmailJS",
    "text": "Send Email Directly From Your Code",
